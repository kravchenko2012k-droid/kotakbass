...
<section class="third-section">
    ...
    <div class="third-section-books">
        ...
        <div class="third-section-book">
            <img src="book1.jpeg" alt="книга 1" class="book-img">
            <h3 class="book-title">Книга 1</h3>
            <p class="book-author">Автор 1</p>
            <p class="book-price">199 грн</p>
        </div>

        <div class="third-section-book">
            <img src="book2.jpeg" alt="книга 2" class="book-img">
            <h3 class="book-title">Книга 2</h3>
            <p class="book-author">Автор 2</p>
            <p class="book-price">249 грн</p>
        </div>

        <div class="third-section-book">
            <img src="book3.jpeg" alt="книга 3" class="book-img">
            <h3 class="book-title">Книга 3</h3>
            <p class="book-author">Автор 3</p>
            <p class="book-price">299 грн</p>
        </div>

        <div class="third-section-book">
            <img src="book4.jpeg" alt="книга 4" class="book-img">
            <h3 class="book-title">Книга 4</h3>
            <p class="book-author">Автор 4</p>
            <p class="book-price">349 грн</p>
        </div>
